...
for r in tqdm(range(reps)):
    ...
    mMs[:, r], CMs[:, :, r], YMs[:, :, r], tMs[:,r] = mod1.MLA(x0M, step, N, burn_in = bi, quiet = True)


#########
# save outputs
np.save("Lap_" + str(step) + '/mLs.npy', mLs)
np.save("Lap_" + str(step) + '/mNs.npy', mNs)
np.save("Lap_" + str(step) + '/mMs.npy', mMs)
np.save("Lap_" + str(step) + '/mTs.npy', mTs)
np.save("Lap_" + str(step) + '/CLs.npy', CLs)
np.save("Lap_" + str(step) + '/CNs.npy', CNs)
np.save("Lap_" + str(step) + '/CTs.npy', CTs)
np.save("Lap_" + str(step) + '/CMs.npy', CMs)
np.save("Lap_" + str(step) + '/YLs.npy', YLs)
np.save("Lap_" + str(step) + '/YNs.npy', YNs)
np.save("Lap_" + str(step) + '/YTs.npy', YTs)
np.save("Lap_" + str(step) + '/YMs.npy', YMs)
np.save("Lap_" + str(step) + '/tLs.npy', tLs)
np.save("Lap_" + str(step) + '/tNs.npy', tNs)
np.save("Lap_" + str(step) + '/tTs.npy', tTs)
np.save("Lap_" + str(step) + '/tMs.npy', tMs)

np.save("Lap_" + str(step) + '/x0N.npy', x0N)
np.save("Lap_" + str(step) + '/x0M.npy', x0M)
np.save("Lap_" + str(step) + '/x0L.npy', x0L)
np.save("Lap_" + str(step) + '/x0T.npy', x0T)
